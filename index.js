...
const defaultSequences = ['[1, 2, 3, 4]', '{a: 1, b: 2}', '`${myvar}`', 'foo -r -e | bar', './start-server -c', 'cd ..; cd /test; npm run compile', '\\n whatever', '<div></div>', 'question? answer!', 'the quick, brown, fox jumped over the lazy dog', '50%', 'we are #1', 'example@example.com', 'for (let x = 0; x < 10; x++) { doThis(thisThing); }', "if __name__ == '__main__':", 'span.success { background-color: salmon; }', 'defp elixirc_paths(:test), do: ["lib", "test/support"]', '$40', '10^2', 'R&R', '10*3', 'function(call)', '10 - 5', '3 + 8', 'snake_case_like_this', 'var = 5;', '~/src/stuff', 'ArrowUp·ArrowUp·ArrowDown·ArrowDown·ArrowLeft·ArrowRight·ArrowLeft·ArrowRight·ba*', 'Control-a·Control-c·Control-v', 'Backspace·Backspace·ArrowLeft·ArrowRight·Tab·ArrowUp·Tab·ArrowDown·Enter', 'Delete·Home·Shift-End·Delete·Shift-Home·Backspace·PageUp·PageDown', 'Shift-ArrowUp·Shift-ArrowLeft', '1234567890', 'qwertyuiop', 'asdfghjkl;', 'zxcvbnm,./', '`[]=-', '·Tab·\\\'Backspace·Delete·Enter·Home·PageUp·End·PageDown', '+!@#$%^&*()_|"~:<>?{}']
